...
send_action "$DEVICE_ID" "runJs" '{"path": "test-scripts/gotoLogin.js"}'
send_action "$DEVICE_ID" "checkLayout" '{"path": "specs/loginPage.gspec", "tags": ["mobile"]}'

send_action "$DEVICE_ID_2" "openUrl" '{"url": "http://testapp.galenframework.com"}'
send_action "$DEVICE_ID_2" "resize" '{"width": 650, "height": 600}'
send_action "$DEVICE_ID_2" "runJs" '{"path": "test-scripts/gotoLogin.js"}'
send_action "$DEVICE_ID_2" "checkLayout" '{"path": "specs/loginPage.gspec", "tags": ["tablet"]}'

send_action "$DEVICE_ID_3" "openUrl" '{"url": "http://testapp.galenframework.com"}'
send_action "$DEVICE_ID_3" "resize" '{"width": 1024, "height": 700}'
send_action "$DEVICE_ID_3" "runJs" '{"path": "test-scripts/gotoLogin.js"}'
send_action "$DEVICE_ID_3" "checkLayout" '{"path": "specs/loginPage.gspec", "tags": ["desktop"]}'
